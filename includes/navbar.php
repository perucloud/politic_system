...
<nav x-data="{ open: false }"
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      ...
      <!-- CTA + Intranet + hamburger -->
      <div class="flex items-center gap-2">
        <!-- Intranet (desktop) -->
        <a href="<?= BASE_URL ?>/admin/login.php"
           class="hidden lg:inline-flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-full
                  border border-gray-200 text-gray-500 bg-white/60 backdrop-blur-sm
          ...
          <svg class="w-3 h-3 opacity-60 group-hover:opacity-100 transition-opacity"
               fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                  d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
          </svg>
          <span class="tracking-wide">Intranet</span>
        </a>
  ...
  <div x-show="open" x-transition class="lg:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-2 max-h-[calc(100vh-4rem)] overflow-y-auto">
    ...
    <div class="border-t border-gray-100 mt-3 pt-3">
      <a href="<?= BASE_URL ?>/admin/login.php"
         @click="open = false"
         class="flex items-center justify-center gap-2 py-2 text-xs font-semibold text-gray-400
                hover:text-[#1E3A8A] transition-colors">
        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
        </svg>
        Intranet — Acceso al panel
      </a>
    </div>
  </div>
</nav>
